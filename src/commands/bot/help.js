    ...
    async execute(interaction, client) {
     ...
     const embed = new EmbedBuilder()
       ...
       .addFields([
         ...
         { name: 'Orginal Developer:', value: `[@YassineHzz](https://youtube.com/c/yassinehzz)`, inline: true },
         { name: 'Edited & Hosted by:', value: `[@Criso](https://crisode.gq/discord )`, inline: true },
          ])
    .setColor(client.mainColor)
        .setFooter({text: `${client.user.tag} | dscolink.ga`, iconURL: client.user.displayAvatarURL()})
